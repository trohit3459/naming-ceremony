export const GIRL_NAMES = [
  { id: "bhargavi", name: "Bhargavi", emoji: "🌸" },
  { id: "bhavya", name: "Bhavya", emoji: "✨" },
  { id: "bhanu", name: "Bhanu", emoji: "☀️" },
  { id: "bhoomi", name: "Bhoomi", emoji: "🌍" },
  { id: "bhumika", name: "Bhumika", emoji: "🌺" },
  { id: "bhuvana", name: "Bhuvana", emoji: "🌙" },
];

export const BOY_NAMES = [
  { id: "bhargav", name: "Bhargav", emoji: "⭐" },
  { id: "bhavik", name: "Bhavik", emoji: "🔥" },
  { id: "bhushan", name: "Bhushan", emoji: "💎" },
  { id: "bhavyajyot", name: "Bhavyajyot", emoji: "🌟" },
  { id: "bhuvan", name: "Bhuvan", emoji: "🌏" },
  { id: "bhaskar", name: "Bhaskar", emoji: "🌞" },
];

export const EVENT_DETAILS = {
  title: "Naming Ceremony",
  subtitle: "Twin Blessings",
  date: "13th May 2026",
  day: "Wednesday",
  time: "7:00 PM Onwards",
  venue: "Shelar Marriage Lawn",
